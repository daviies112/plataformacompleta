            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Nossa equipe está analisando suas informações e retornaremos em breve pelo WhatsApp."
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Obrigado por preencher o formulário. Nossa equipe analisará suas respostas."
                  className="bg-background border-border resize-none"
                  rows={3}
                />
              </div>
