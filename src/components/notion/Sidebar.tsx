...
import { Search, Plus, ChevronRight, ChevronDown, FileText, Table, Star, LayoutGrid, Copy, Trash2, PanelLeftClose, PanelLeftOpen } from 'lucide-react';
...
export const Sidebar = () => {
  ...
  return (
    <div
      className={cn(
        "bg-background/80 backdrop-blur-xl backdrop-saturate-150 border-r border-border/50 flex flex-col h-full shadow-xl transition-all duration-300 relative group",
        isCollapsed ? "w-12" : "w-64"
      )}
    >
      {/* Collapse Toggle Button */}
      <div className={cn(
        "flex items-center justify-between p-2 pt-3",
          ...
          <div className="flex-1 px-1">
            <div className="relative group/search">
              ...
              <Input
                ...
                className="pl-9 h-8 text-sm bg-muted/30 border-none focus-visible:ring-1 focus-visible:ring-primary/30"
              />
            </div>
          </div>
        )}
        <Button
          ...
          className={cn(
            "h-8 w-8 text-muted-foreground hover:text-primary hover:bg-primary/10 active:bg-primary active:text-primary-foreground transition-all",
            isCollapsed && "mt-2"
          )}
      ...
      {!isCollapsed ? (
        ...
        <div className="flex-1 flex flex-col items-center py-4 gap-6 text-muted-foreground/60">
          <div onClick={() => setIsCollapsed(false)} className="cursor-pointer hover:text-primary transition-colors" title="Páginas">
            <FileText className="h-5 w-5" />
          </div>
          <div onClick={() => setIsCollapsed(false)} className="cursor-pointer hover:text-primary transition-colors" title="Databases">
            <Table className="h-5 w-5" />
          </div>
          <div onClick={() => setIsCollapsed(false)} className="cursor-pointer hover:text-primary transition-colors" title="Quadros">
