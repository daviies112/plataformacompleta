...
import { LogoHeader } from '@/components/assinatura/verification/LogoHeader';
...
const AssinaturaClientContent = () => {
  ...
  if (currentStep >= 1 && currentStep <= 6) {
    return (
      <div className="min-h-screen flex flex-col" style={{ backgroundColor: contract.background_color || '#ffffff' }}>
        <LogoHeader
          logoUrl={contract.logo_url}
          logoSize={contract.logo_size}
          logoPosition={contract.logo_position}
        />
          ...
          <Suspense fallback={<StepLoader />}>
            {currentStep === 1 && (
              <VerificationFlow
                ...
                titleColor={contract.title_color || contract.primary_color || primaryColor}
                ...
                logoUrl={undefined} // Logo already rendered by LogoHeader
            ...
            {currentStep === 3 && (
              <ResellerWelcomeStep
                ...
                parabens_background_color="transparent"
